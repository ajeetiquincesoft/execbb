...
class SendListingFactsheetController extends Controller
{
    protected $database;
    protected $reference;
    ...
    public function index()
    {
        ...
        return view('agent-dashboard.send_listing_factsheet.index', compact('buyers', 'listings'));
    }
    public function shareListingFactsheet(Request $request)
    {
