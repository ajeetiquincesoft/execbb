...
class BuyerOfferController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.buyer.offer.index', compact('offers', 'company_name'));
    }
    public function create()
    {
        session()->forget(['offerData', 'step','activityCreated']);
        return redirect()->route('buyer.offer.form');
    }
    ...
    public function showForm(Request $request)
    {
        ...
        return view('frontend.buyer.offer.create', compact('step', 'offerData', 'buyers', 'agents', 'states', 'listings', 'nextOfferId', 'offer_types'));
    }
     ...
     public function processForm(Request $request)
     {
         ...
         if ($step == 1) {
             ...
             if ($request->has('next')) {
                 ...
                 $offer->save();
                 session()->forget(['offerData', 'step']);
                 return redirect()->route('buyer.all.offer')->with('success', 'Your offer create successfully!');
             }
         }
     ...
     public function editForm(Request $request, $id)
     {
         ...
         return view('frontend.buyer.offer.edit', compact('step', 'offerData', 'buyers', 'agents', 'states', 'listings', 'offer', 'offer_types', 'previous', 'next'));
     }
     public function editProcessForm(Request $request, $id)
     {
         ...
         if ($step == 1) {
             ...
             if ($request->has('next')) {
                 ...
                 if ($request->has('comments')) {
                     ...
                     $offer->save();
                     session()->forget(['offerData', 'step']);
                     return redirect()->route('buyer.all.offer')->with('success', 'Your offer has been update successfully!');
                 }
             }
         }
         ...
         // Store the new step in the session
         session(['step' => $step]);
         return redirect()->route('buyer.edit.offer.form', ['id' => $offer->OfferID]);
     }
     public function show($id)
     {
         ...
         return view('frontend.buyer.offer.show', compact('offer', 'previous', 'next', 'company_name', 'buyer_name','activities'));
     }
     public function destroy(Request $request, $id)
     {
         ...
         if (!$offer) {
             return redirect()->route('buyer.all.offer')
                 ->with('err_message', 'Offer not found.');
         }
