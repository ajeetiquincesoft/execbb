...
@section('content')
    <div class="container-fluid content nextPreviousButtons">
        <div class="next-back-page d-flex justify-content-between">
            @if ($previous)
                <a href="{{ route('agent.show.agent.showing', $previous->ShowingID) }}"><button><i
                            class="fa fa-chevron-left"></i></button></a>
            @endif

            @if ($next)
                <a href="{{ route('agent.show.agent.showing', $next->ShowingID) }}"><button><i
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="profile-info">
                            <div class="text-end">
                                <a href="{{ route('edit.showing', $showing->ShowingID) }}"><i
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="{{ url('assets/images/company.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Agent</span></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ url('assets/images/press_owner.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Date</span></td>
                                        ...
                                        <tr>
                                            <td><img src="{{ url('assets/images/phone.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Follow Up</span></td>
