...
@section('content')
    <div class="container-fluid content" style="background-color: #f8f9fa; padding: 2rem 2rem 0rem 2rem;">
        <div class="next-back-page d-flex justify-content-between">
            @if ($previous)
                <a href="{{ route('agent.show.buyer', $previous->BuyerID) }}"><button><i
                            class="fa fa-chevron-left"></i></button></a>
            @endif

            @if ($next)
                <a href="{{ route('agent.show.buyer', $next->BuyerID) }}"><button><i
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">{{ $buyer->HomePhone ?: ($buyer->BusPhone ?: 'N/A') }}
                                            </td>
                                        </tr>
                                        <tr>
