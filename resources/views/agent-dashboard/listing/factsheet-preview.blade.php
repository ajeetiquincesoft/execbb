...
<body>
    <div class="container">
        ...
        <h3>Listing Factsheet Preview</h3>
        ...
        <div class="card p-4">
            ...
            <table border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse"
                ...
                <tbody>
                    <tr>
                        ...
                        <td valign="top" style="font-size: 18pt">
                            <p style="text-align: right; font-size: 10pt;">
                                Fact sheet&nbsp;
                                <i>as of:&nbsp;{{ $currentDate->format('m-d-Y') }}</i>
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="font-size: 8pt" width="572" height="142">
                            <table border="0" cellspacing="0" cellpadding="0" height="50" bordercolor="#FFFFFF"
                                bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
                                <tbody>
                                    <tr>
                                        <td style="font-size: 8pt"><b>ID#:</b></td>
                                        <td colspan="3" style=" font-size: 8pt">{{ $listingData->ListingID }}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style=" font-size: 12pt"><b>{{ $listingData->DBA }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style=" font-size: 8pt">{{ $listingData->Address1 }}.
                                        </td>
                                        <td style="font-size: 8pt"></td>
                                    </tr>
                                    <tr>
                            ...
                            <table border="0" cellspacing="0" style="border-collapse: collapse"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt" valign="middle">
                                            <u>{{ $listingData->YrsEstablished }}</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                        ...
                                        <td style="font-size: 8pt" valign="middle">
                                            <u>{{ $listingData->YrsPresentOwner }}</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                    ...
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                            Product Mix: </td>
                                        <td style="font-size: 8pt" valign="middle"><u>{{ $listingData->Product }}</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 8pt" valign="middle">
                                            <u>{{ $listingData->InvNot ?? 0 }}</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                            Additional Terms: </td>
                                        <td style="font-size: 8pt" valign="middle"><u>{{ $listingData->AddTerm }}</u>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 8pt" valign="middle">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            <td style="font-size: 8pt; text-align: left;"><b>Total Cost of Sales:</b>
                                            </td>
                                            <td style="font-size: 8pt; text-align: right;">
                                        ...
                                        <tr>
                                            <td style="font-size: 8pt; text-align: right;" valign="bottom"
                                                colspan="2">
                                        ...
                                        <tr>
                                            @php
                                                ...
                                                $percentageCommonAreaMaint =
                                                    $annualSaleAmount > 0
                                                        ? ($commonAreaMaint / $annualSaleAmount) * 100
                                                        : 0;
                                            @endphp
                                        ...
                                        <tr>
                                            @php
                                                ...
                                                $percentageRealEstateTax =
                                                    $annualSaleAmount > 0
                                                        ? ($realEstateTax / $annualSaleAmount) * 100
                                                        : 0;
                                            @endphp
                                        ...
                                        <tr>
                                            @php
                                                ...
                                                $percentageAdvertising =
                                                    $annualSaleAmount > 0
                                                        ? ($advertising / $annualSaleAmount) * 100
                                                        : 0;
                                            @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 8pt; text-align: left;">Utilities, Gas / Electric:
                                            </td>
                                            <td style="font-size: 8pt; text-align: right;">
                                        ...
                                        <tr>
                                            @php
                                                ...
                                                $percentageMaintenance =
                                                    $annualSaleAmount > 0
                                                        ? ($maintenance / $annualSaleAmount) * 100
                                                        : 0;
                                            @endphp
                                        ...
                                        <tr>
                                            @php
                                                $totalOperatingProfit =
                                                    ($listingData->AnnualSales ?? 0) -
                                                    ($totalCost + $totalOperatingExpenses);
                                        ...
                                        <tr style="margin-botton: 10px;">
                                            @php
                                                ...
                                                $percentageAdjCashFlow =
                                                    $annualSaleAmount > 0
                                                        ? ($adjCashFlow / $annualSaleAmount) * 100
                                                        : 0;
                                            @endphp
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;" style="font-size: 8pt">
                            <table border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse"
                                ...
                                <tbody>
                                    <tr>
                                        <td width="100%" style="font-size: 8pt; font-weight: bold">Footnotes and
                                            Legend: ()
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center; font-size: 8pt">
                                            2583 Morris Ave Union, NJ 07083 Phone: (908)851-9040 Fax: (908)851-9066
                                            Email:
                                            sales@execbb.com</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center; font-size: 8pt">*All information is from sources
                                            deemed
                                            reliable and is submitted subject to errors, omissions, change of price,
                                            rental,
        ...
        <div class="mt-4 factsheet-actions">

            <a href="{{ route('agent.download.listing.factsheet', $listingData->ListingID) }}" class="btn-download">
                Download
            </a>
