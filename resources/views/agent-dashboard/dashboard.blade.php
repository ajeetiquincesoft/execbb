    ...
    <div class="container-fluid content bg-light">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 ">
                <a href="{{ route('agent.all.listing') }}" class="card-link">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('agent.list.buyer') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Total Buyers</h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('agent.all.leads') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Total Leads</h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('agent.buyer.listing.visit') }}" class="card-link">
                    <div class="card view-data">
                        <div>
