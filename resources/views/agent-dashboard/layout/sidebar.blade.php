<div id="sidebar" class=" text-white">
    <div class="position-relative img-bg ">
        <div class="p-3">
            <a href="{{ url('agent/dashboard') }}"><img class="sidebar-logo" src="{{ url('assets/images/main_logo.png') }}"
                    alt=""></a>
                        ...
                        <ul class="nav custom-fontsize flex-column px-2">
                            <li class="nav-item">
                                ...
                                <a class="nav-link text-white" data-name="Dashboard"
                                    data-url="{{ url('agent/dashboard') }}"
                                    href="{{ url('agent/dashboard') }}">Dashboard</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.list.buyer') || request()->routeIs('agent.show.buyer') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Buyers.png') }}">
                                <a class="nav-link" href="{{ route('agent.list.buyer') }}">Buyers</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.all.listing') || request()->routeIs('agent.listing.form') || request()->routeIs('agent.edit.listing.form') || request()->routeIs('agent.show.listing') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Listing.png') }}">
                                <a class="nav-link" href="{{ route('agent.all.listing') }}">Listings</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.all.leads') || request()->routeIs('agent.show.lead') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Lead.png') }}">
                                <a class="nav-link" href="{{ route('agent.all.leads') }}">Leads</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.buyer.listing.visit') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Buyers.png') }}"><a class="nav-link"
                                    href="{{ route('agent.buyer.listing.visit') }}">Buyer Visit</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.all.message.info') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Buyers.png') }}"><a class="nav-link"
                                    href="{{ route('agent.all.message.info') }}">Messages</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.buyer.referrals.list') ? 'activenavitem' : '' }}">
                                <img src="{{ url('assets/images/Referrals.png') }}"><a class="nav-link"
                                    href="{{ route('agent.buyer.referrals.list') }}">Buyer NDA</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.all.showing.agent') ? 'activenavitem' : '' }}">
                ...
                <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <ul class="acc-list" style="list-style-type: none; padding: 0;">
                            <li class="nav-item {{ request()->routeIs('agent.reports') ? 'activenavitem' : '' }}"><a
            ...
            <div class="accordion-item px-2">
                ...
                <div id="collapsetwo" class="accordion-collapse collapse " aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <ul class="acc-list" style="list-style-type: none; padding: 0;">
                            <li
                                class="nav-item {{ request()->routeIs('agent.reset.password') ? 'activenavitem' : '' }}">
                                <a class="nav-link-dropdown" href="{{ route('agent.reset.password') }}">Reset Pwd</a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('agent.login.activities') ? 'activenavitem' : '' }}">
                                <a class="nav-link-dropdown" href="{{ route('agent.login.activities') }}">Login
                                    List</a>
                            </li>
                        </ul>
                    </div>
