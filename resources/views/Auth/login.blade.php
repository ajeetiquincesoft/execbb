                ...
                <div class="row g-0">
                    <div class="col-md-12 d-flex align-items-center content-center">
                        <div class="card-body text-black" style="width: 100%;">
                            ...
                            <p class="m-0 mb-3 an_account" style="color: #5D5D5D;">Don't have an account? <a
                                    href="{{ route('register.ebb.buyer') }}" style="color: #7F2149;">Create your free
                                    account</a></p>
                            ...
                            <form method="POST" action="{{ route('login.custom') }}" id="login_user">
                                ...
                                <div class="pt-1 mt-1 d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div>
                                        <a class="small text-muted" href="{{ route('forget.password') }}"
                                            style="color: #7F2149 !important;text-decoration: underline;">Forgot
                                            password?</a>
                                    </div>
                                </div>
