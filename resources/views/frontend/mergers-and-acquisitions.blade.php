            ...
            <div class="row px-3 px-md-5 mt-0 mt-md-5">
                ...
                <div class="col-md-8 main-head mar_acq">
                    <div class="Content-text">
                        ...
                        <p>In most cases it is more profitable for a business to grow by acquisition. It is also faster,
                            more economical, less risky and easier to finance. If you are considering a merger/acquisition,
                            our advice is for you to base your purchase on strategic value, not price.</p>
                        <p>Each year, EBB assists buyers and sellers with acquiring or selling businesses for strategic
                            reasons. In some instances, we have been able to match buyers with businesses not originally up
                            for sale.</p>
                        <p>Specifically, we can help you find a business and locate a buyer, then negotiate and close the
                            deal. More importantly, we can help you understand the more complex issues around acquiring or
                            merging a business into your company, such as:</p>
                        <p>- How to Structure the Deal</p>
                        <p>- Determining <a href="{{ route('business.valuation') }}"
                                style="color: #7F2149; text-decoration: underline;">Market Value</a></p>
                        <p>- Conducting <a href="{{ route('duediligence') }}"
                                style="color: #7F2149; text-decoration: underline;">Due Diligence</a> on a Business</p>
                        <p>Interested in exploring your M&A options with EBB? We encourage you to <a
                                href="{{ route('contact.us') }}" style="color: #7F2149; text-decoration: underline;">contact
