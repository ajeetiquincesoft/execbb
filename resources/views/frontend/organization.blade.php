            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-12 main-head">
                    <div class="Content-text">
                        ...
                        <p>This information came from the <a href="https://www.nj.gov/Business.shtml"
                                style="color: #7F2149; text-decoration: underline;">State of New Jersey’s Web site.</a>
                        ...
                        <p>There are three most commonly used business organizations: Sole Proprietorship, Partnership and
                            Corporation. Here are the advantages and disadvantages of each.</p>
                            ...
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td style="vertical-align: top; padding-left: 10px;">
                                        <p><a href="{{ route('proprietor') }}"
                                                style="color: #7F2149; text-decoration: underline;">Sole Proprietorship</a>
                                        </p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="vertical-align: top; padding-left: 10px;">
                                        <p><a href="{{ route('partnership') }}"
                                                style="color: #7F2149; text-decoration: underline;">Partnership</a></p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td style="vertical-align: top; padding-left: 10px;">
                                        <p><a href="{{ route('corp') }}"
                                                style="color: #7F2149; text-decoration: underline;">Corporation</a></p>
                                    </td>
                                    <td>
