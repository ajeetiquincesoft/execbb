            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>This important step is the close examination of public and proprietary information related to the
                            assets and liabilities of the business being purchased. Due diligence covers background,
                            finance, human resources, tax and legal matters.</p>
                        ...
                        <p><a href="javascript:void(0);" class="checkList"
                                style="color: #7F2149; text-decoration: underline;">Due Diligence Check List</a></p>
                    </div>
                </div>
                <!-- Side Panel -->
                    ...
                    <div class="Ebb-section-about">
                        ...
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                ...
                                <p>List <a href="{{ route('list.with.ebb') }}"
                                        style="color: #7F2149; text-decoration: underline;">your business with EBB.</a></p>
                            </div>
                        </div>
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                ...
                                <p>Set up a <a href="{{ route('strategic.alliances') }}"
                                        style="color: #7F2149; text-decoration: underline;">strategic alliance</a> with EBB
                                    and receive commissions and business.</p>
                            </div>
                        </div>
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                <h5>10 Questions to Ask</h5>
                                <p>Considering a business broker? <a href="#"
