        ...
        <div class="row px-3 px-md-5 ab_ebb">
            ...
            <div class="col-md-8 main-head">
                <div class="Content-text question">
                    ...
                    <p>To obtain recognition as a NJ QSSS, companies must file the revised <a href="#" style="color: #7F2149; text-decoration: underline;" >form CBT-2553</a> along with a copy of <a href="#" style="color: #7F2149; text-decoration: underline;" >Federal Form 966</a> before the 16th day of the fourth month of the first tax year the election is to take place.</p>
                    <p>To maintain the separate entity principle, every qualified NJ QSSS must <a href="#" style="color: #7F2149; text-decoration: underline;" >file a CBT-100S</a> and pay the minimum tax of $200. Unless the NJ QSSS formally dissolves or withdraws with the Division of Revenue, Business Services Bureau, it will be required to file report with the NJ Division of Revenue and a <a href="#" style="color: #7F2149; text-decoration: underline;" >Corporation Business Tax Return</a>.</p>
                    <p>The parent corporation must consent to taxation by NJ by <a href="#" style="color: #7F2149; text-decoration: underline;" >filing a CBT-100</a> or <a href="#" style="color: #7F2149; text-decoration: underline;" >CBT-100S</a> which includes the QSSS’s assets, liabilities, income, and expenses. The property, receipts, and payroll of the QSSS must be included in the parent corporation's allocation factor. Failure of the parent corporation to either consent/file a CBT-100/CBT-100S for a period will result in denial of status and the subsidiary will be subject to taxation in NJ as a <a href="{{route('ccorp')}}" style="color: #7F2149; text-decoration: underline;" >C Corporation</a>.</p>
                </div>
            </div>
            <!-- Side Panel -->
