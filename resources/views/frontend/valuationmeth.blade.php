            ...
            <div class="row px-3 px-md-5 mt-0 mt-md-5">
                ...
                <div class="col-md-8 main-head mar_acq">
                    <div class="Content-text">
                        ...
                        <p>Here are several methods for determining the value of a business. Executive Business Brokers uses
                            a multiple of the seller's discretionary cash (SDC) to determine a business' worth in the
                            marketplace.</p>
                        <h3 class="section-heading">Multiple of Discretionary Cash (SDC)</h3>
                        <p>This Method uses a multiple of seller's discretionary cash flow. Retail businesses generally
                            range from 0-2 times the SDC. Manufacturing, distributing and service businesses range from 0-4
                            times SDC. Plus the depreciated value of the fixtures & equipment, wholesale value of the
                            salable inventory and market value of the real estate if included.</p>
                        ...
                        <p>Used when purchasing an existing business. Value is based on estimating the start up costs minus
                            what is missing plus a premium for the time saved.</p>
                        ...
                        <p>Uses an industry average sales figure from recent sales of comparable business. The value of a
                            business is determined by multiplying the sales by the gross sales.</p>
                        <h3 class="section-heading">Excess Earning Method</h3>
                        <p>Estimated from an industry average and is similar to the capitalized earnings approach. Here the
                            return on assets is separated from other earnings ("excess" earnings) generated.</p>
