                    ...
                    <div class="container my-5">
                        <div class="row g-4">
                            <div class="col-12 col-md-4">
                                <a href="https://www.amazon.com/exec/obidos/ASIN/0028629035/executivebu0f-20" ><img src="{{asset('assets/images/image_1.jpg')}}" alt="Image 1" class="buyer_resource_img"></a>
                            </div>
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/1574100874/executivebu0f-20" ><img src="{{asset('assets/images/image_2.jpg')}}" alt="Image 2" class="buyer_resource_img"></a>
                            </div>
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/1564143430/executivebu0f-20" ><img src="{{asset('assets/images/image_3.jpg')}}" alt="Image 3" class="buyer_resource_img"></a>
                            </div>
                        </div>
                    </div>
                    <div class="container my-5">
                        <div class="row g-4">
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/1558507027/executivebu0f-20" ><img src="{{asset('assets/images/image_4.jpg')}}" alt="Image 1" class="buyer_resource_img"></a>
                            </div>
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/0793104505/executivebu0f-20" ><img src="{{asset('assets/images/image_5.jpg')}}" alt="Image 2" class="buyer_resource_img"></a>
                            </div>
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/1580620051/executivebu0f-20" ><img src="{{asset('assets/images/image_6.jpg')}}" alt="Image 3" class="buyer_resource_img"></a>
                            </div>
                        </div>
                    </div>
                    <div class="container my-5">
                        <div class="row g-4">
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/0471150479/executivebu0f-20" ><img src="{{asset('assets/images/image_7.jpg')}}" alt="Image 1" class="buyer_resource_img"></a>
                            </div>
                            <div class="col-12 col-md-4">
                            <a href="https://www.amazon.com/exec/obidos/ASIN/0965657833/executivebu0f-20" ><img src="{{asset('assets/images/image_8.jpg')}}" alt="Image 2" class="buyer_resource_img"></a>
                            </div>
                        </div>
                    </div>
