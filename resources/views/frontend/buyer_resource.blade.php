                    ...
                    <div class="Content-text">
                        ...
                        <div class="container my-5">
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-4">
                                    <a href="https://www.amazon.com/exec/obidos/ASIN/1564143430/executivebu0f-20"><img
                                            src="{{ asset('assets/images/image_3.jpg') }}" alt="Image 3"
                                            class="buyer_resource_img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="container my-5">
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-4">
                                    <a href="https://www.amazon.com/exec/obidos/ASIN/0793104505/executivebu0f-20"><img
                                            src="{{ asset('assets/images/image_5.jpg') }}" alt="Image 2"
                                            class="buyer_resource_img"></a>
                                </div>
                                <div class="col-12 col-md-4">
                ...
                <div class="col-md-4" style="background-color: #F8F8F8;;">
                    <div class="Ebb-section-about">
                        {{-- <div class="boxes-button-section">
                            ...
                            <p>Become an <a href="{{ route('preferred.buyers.program') }}" class="sellorgive">EBB Preferred
                                    Buyer</a> and benefit from our full services.</p>
                        </div> --}}
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
