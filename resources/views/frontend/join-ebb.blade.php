            ...
            <div class="row px-3 px-md-5 mt-2 mt-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text">
                        ...
                        <p class="join_us_p">Business brokerage is a niche industry that offers opportunity and unlimited
                            earning potential. Regardless of the economic environment, people buy and sell businesses for
                            many reasons. In the US, where 20% of the 16M private small businesses are for sale at any one
                            time, there is a huge opportunity for intermediaries.</p>
                        <p class="join_us_p">Professional business brokers deal with both current and potential business
                            owners. For many, the decision to purchase or sell a business is one of the largest financial
                            decisions they will ever make. The <a href="{{ route('job_description') }}"
                                class="sellorgive">role of a business broker</a> is to help turn their hopes and dreams into
                            a reality.</p>
                        <p class="join_us_p">Executive Business Brokers is looking for individuals who fit the <a
                                href="{{ route('qualifications') }}" class="sellorgive">business broker profile</a>. They
                            are honest professionals who work hard, have self-discipline, communicate well with others and
                            possess a willingness to learn. Our <a href="{{ route('compensation') }}"
                                class="sellorgive">compensation</a> is competitive with the industry.</p>
                        <p class="join_us_p">As part of our team, you will benefit from our name recognition and reputation
                            for quality professional service, our <a href="{{ route('multimarketing') }}"
                                class="sellorgive">extensive marketing programs</a> and our <a
