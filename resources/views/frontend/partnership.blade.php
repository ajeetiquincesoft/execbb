...
<div class="container my-7">
    <div class="content-box">
        <div class="row">
            <div class="about_EBB">
                <h5 class="main-heading">Partnership</h5>
            </div>
        </div>
        <div class="row px-3 px-md-5 ab_ebb">
            ...
            <div class="col-md-8 main-head">
                <div class="Content-text">
                    <h3 class="section-heading">Partnership</h3>
                    ...
                    <p>In a partnership, the liability of each general partner for all the debts of the firm is unlimited and both parties are personally responsible for all the debts of the business. The amount could be in excess of the amount invested in the business.</p>
                    <p>A partnership lacks continuity – the business terminates upon the death of the owner/partner, or upon the withdrawal of a partner. Some situations call for a limited partnership (Refer to the NJ State Statured--N.J.S.A 42:2a).</p>
                    <p>There are several factors to consider when evaluating whether to take on a partner:</p>
                    <p>- Financing. It is the owners’ responsibility to provide, or obtain
                        from others, sufficient money to establish a firm foundation for the
                        enterprise.</p>
                    <p>- Missing technical or management skills. You can obtain skills you
                        are missing through a business partner. </p>
                    <p>- Base your decision on logic and not on emotion. Look at
                        compatibility, personality and character, as well as the ability to
                        render technical or financial assistance. </p>
                </div>
            </div>
            <!-- Side Panel -->
