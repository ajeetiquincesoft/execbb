            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>1. Establish a <a href="{{ route('business.valuation') }}"
                                style="color: #7F2149; text-decoration: underline;">fair and accurate selling price</a>
                            through hands-on
                            assessment.</p>
                        ...
                        <p>6. Expose the business to potential buyers daily through proven <a
                                href="{{ route('multimarketing') }}"
                                style="color: #7F2149; text-decoration: underline;">media sources</a> – including the
                            Internet.</p>
                        ...
                        <p>11. Assist the buyer in arranging <a href="{{ route('financing') }}"
                                style="color: #7F2149; text-decoration: underline;">financing.</a></p>
