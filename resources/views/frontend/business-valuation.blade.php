            ...
            <div class="row px-3 px-md-5 mt-0 mt-md-5">
                ...
                <div class="col-md-8 main-head bus_valu">
                    <div class="Content-text">
                        ...
                        <p>Valuing a business is not an exact science. There is no right way to determine price, as there
                            are many <a href="{{ route('valuationmeth') }}"
                                style="color: #7F2149; text-decoration: underline;">methods</a> of doing so. <a
                                href="{{ route('valuationfactors') }}"
                                style="color: #7F2149; text-decoration: underline;">Many factors</a> play into value – the
                            economy, management, location, cash flow, lease, etc.</p>
                        <p>EBB uses a multiple of the seller’s discretionary cash (SDC) to determine a business’ worth in
                        ...
                        <p><a href="{{ route('contact.us') }}" style="color: #7F2149; text-decoration: underline;">Ask EBB
                            </a>to help you determine the value of your business.</p>
                    </div>
                </div>
                <!-- Side Panel -->
