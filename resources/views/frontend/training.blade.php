            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>Held over three days at our corporate headquarters, the Executive Business Brokers (EBB)
                            comprehensive training program is designed to equip you with the knowledge, tools and technology
                            you need to become a successful business broker. The topics we cover include:</p>
                    ...
                    <div class="Ebb-section-about">
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                ...
                                <p>EBB can <a href="#" style="color: #7F2149; text-decoration: underline;">Send us</a>
                                    your resumé.</p>
                            </div>
                        </div>
                        <div class="boxes-button-section">
