        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('buyer.tools') }}">Tool</a></li>
        ...
        <div class="content-box">
            <div class="row">
                <div class="about_EBB">
                    ...
                    <p class="sub-title">Buying a business is a complex and time consuming process that can be broken down
                        into four main phases.</p>
                </div>
            </div>
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text">
                        ...
                        <p>Signing this document gives you access to sensitive information regarding the seller and their
                            business. It also protects the seller by ensuring you will keep information disclosed during
                            negotiations confidential.<a href="javascript:void(0);" class="showingAgreement"
                                style="color: #7F2149; text-decoration: underline;"> Example</a></p>
                        <h3 class="section-heading">Phase 2: Preliminary Negotiations/Letter of Intent</h3>
                        <p>Both parties negotiate a letter of intent, which is non-binding and forms the basis for the
                            definitive agreement. It outlines the deal structure, the purchase price and form, payment terms
                            and closing contingencies.<a href="javascript:void(0);" class="offerToPurchase"
                                style="color: #7F2149; text-decoration: underline;"> Example</a></p>
                        <h3 class="section-heading">Phase 3: Due Diligence</h3>
                        <p>During <a href="{{ route('duediligence') }}" class="sellorgive">due diligence</a> - this vitally
                            important phase - you will examine the business background, finance, human resources, tax and
                            legal matters.</p>
                        <h3 class="section-heading">Phase 4: Negotiation/Definitive Acquisition Agreement</h3>
                        <p>There are four main sections of the Definitive Acquisition Agreement: purchase price,
                            representations, indemnification and covenants.</p>
                        <div class="adove_img">
                            <img src="{{ asset('assets/images/logo_adobe.gif') }}" alt="IBBA Logo"
                                class="img-fluid adove-logo">
                        </div>
                    </div>
                </div>
                <!-- Side Panel -->
                    ...
                    <div class="Ebb-section-about">
                        ...
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                ...
                                <p>Learn about the different types of <a href="{{ route('organization') }}"
                                        style="color: #7F2149; text-decoration: underline;">business status</a>.</p>
                            </div>
