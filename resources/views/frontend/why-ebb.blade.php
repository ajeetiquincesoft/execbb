            ...
            <div class="row px-3 px-md-5 mt-0 mt-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text">
                        ...
                        <p>Executive Business Brokers has handled the marketing and sales efforts for over 1,000 small to
                            mid-sized businesses in retail, service, and manufacturing and distribution industries. Our
                            consultative approach to buying and selling makes selling a business easier.</p>
                        <h3 class="section-heading mt-5">EBB Guides You through the Process</h3>
                        <p>As an objective third party we will review your business operation to help you determine its fair
                            market value in today’s marketplace. We will also coordinate and attend meetings with the
                        ...
                        <p>Our aggressive <a href="#" class="sellorgive">multi-level marketing</a> effort that
                            ...
                            resources. <span>ALL prospective buyers sign a confidentiality and non-disclosure agreements
                                prior to viewing details of your businesses.</span></p>
                    </div>
                </div>
                <!-- Side Panel -->
