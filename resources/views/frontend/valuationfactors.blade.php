            ...
            <div class="row px-3 px-md-5 mt-0 mt-md-5">
                ...
                <div class="col-md-8 main-head mar_acq">
                    <div class="Content-text question">
                        ...
                        <p>While business valuations are very subjective, there are 16 key factors to take into
                            consideration when valuing a business.</p>
                        <ol type="1" class="factor_valuation">
                            ...
                            <li>Marketing – What stage is the business in – infancy or maturity? How long has the present
                                owner owned it? What is the primary source of sales? How is the company positioned? What are
                                the marketing/sales programs?</li>
                            <li>Presentation – Is the business presentable (clean, organized)? What is the condition of
                                environment?</li>
                            <li>Business Hours – What is the number of days and hours of operation?</li>
                            <li>Type of Products/Services – Are the products/services proprietary or commodities? Are they
                                diverse? What are their advantages?</li>
                            <li>Type of Business – Is it a franchise or an existing business?</li>
                            <li>Systems –What are the systems in place for accounting, employee management,
                                software/hardware and sales/marketing?</li>
                            <li>Financial Outlook – What is the asset base (high or low)? Are there records that reflect
                                profit/sales trends? Is revenue sustainable? What are the growth and expansion
                                opportunities? What is owed and what is coming in (debts, credits and receivables)?</li>
                            <li>Marketplace - Who are the competitors? What are the barriers? How does the industry
                                landscape look? What is the geography/location of the business?</li>
                            ...
                            <li>Suppliers – What are the # of vendors, their contribution to the business and how much does
                                the business depend upon them?</li>
                            <li>Relationships/Uninterrupted business – Can customer, supplier and employee relationships
                                withstand a change in ownership?</li>
                            <li>Legal Issues – Are there any lawsuits, environmental issues or pending regulatory changes?
                            </li>
                            <li>Terms & Stock – Will the purchaser buy or the seller sell? Does it require a low or high
                                down payment?</li>
                        </ol>
