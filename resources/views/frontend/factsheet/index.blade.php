                    ...
                    <table border="0" width="698" cellspacing="0" cellpadding="0" height="50" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="66" style="font-family: Arial; font-size: 10pt" height="3">&nbsp;{{$listingData->State}}</td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    $total = 1000000;
                                    $percentageCOG1 = ($value / $total) * 100;
                                @endphp
                                <td style="font-family: Arial; font-size: 10pt" width="94" align="right" height="16"><u>{{$listingData->COG1 ?? 0}}</u></td>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    $total = 1000000;
                                    $percentageCOG2 = ($value / $total) * 100;
                                @endphp
                                <td style="font-family: Arial; font-size: 10pt" width="94" align="right" height="16"><u>&nbsp;{{$listingData->COG2 ?? 0}}</u></td>
                            ...
                            <tr>
                                ...
                                @php
                                    ...
                                    $total = 1000000;
                                    $percentageCOG3 = ($value / $total) * 100;
                                @endphp
                                <td style="font-family: Arial; font-size: 10pt" width="94" align="right" height="16"><u>&nbsp;{{$listingData->COG3 ?? 0}}</u></td>
                            ...
                            <tr>
                                 @php
                                    ...
                                    $total = 1000000;
                                    $percentageTotalCost = ($totalCost / $total) * 100;
                                @endphp
                            ...
                            <tr>
                                ...
                                <td style="font-family: Arial; font-size: 10pt" width="94" align="right" height="16"><u>&nbsp;$729,300.00</u></td>AnnRent
