        ...
        <div class="row px-3 px-md-5 ab_ebb">
            ...
            <div class="col-md-8 main-head">
                <div class="Content-text">
                    ...
                    <p>Enlisting the help of qualified outsiders who are impartial and specialize in the different areas of selling your business will save you both time and money.</p>
                    ...
                    <p>Before you put your business on the market for sale, make sure it is salable by identifying and solving any issues. Conduct a thorough examination of your company’s finances and liabilities, as well as the market conditions. Consider hiring an independent third party to assess the value. They can re-cast the financial statements and show true profitability and value to determine a fair and accurate price.</p>
                    <h3 class="section-heading">Step 2: Finding Buyers</h3>
                    <p>Locating and then qualifying buyers is difficult. Confidentiality is an issue and screening is a time-consuming process. First you will need to identify their objectives. Are they a first time-buyers, experienced business owners, <a href="#" style="color: #7F2149; text-decoration: underline;">investors</a> or <a href="" style="color: #7F2149; text-decoration: underline;">corporate</a> buyers? Then you will need to look into their background, check their references and assess their financial position.</p>
                    <h3 class="section-heading">Step 3: Negotiating and Closing the Deal</h3>
                    <p>Hundreds of points will be covered during negotiations such as terms of payment, employee contracts, royalties, non-compete agreements and warrantees. Calling in the experts – lawyers, accountants and investment bankers - early may protect you and ensure you end up with a deal that is fair for all parties involved.</p>
                </div>
            </div>
            <!-- Side Panel -->
