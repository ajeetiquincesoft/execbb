            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>This is a business where one person furnishes all the capital and assumes all the responsibility
                            and liability. The business terminates upon the death of the owner.</p>
                        <p>If you have the skills and capital necessary to operate your business, then this form of business
                            organization should be considered very carefully.</p>
                    </div>
                </div>
                <!-- Side Panel -->
