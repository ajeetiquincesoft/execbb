                    ...
                    <div class="Content-text">
                        ...
                        <p>EBB brings together individuals with various levels of experience and provides them with
                            <a href="{{ route('buyer.tools') }}" class="sellorgive">buying tools</a> and <a
                                href="{{ route('seller.tools') }}" class="sellorgive">selling tools</a>. We guide and
                            facilitate the process of buying and selling a
                            business, saving our clients both time and money. Our fees are paid by the seller.
                        </p>
