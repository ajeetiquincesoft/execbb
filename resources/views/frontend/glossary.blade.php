                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse"
                                ...
                                <tbody>
                                    @foreach ($glossaryTerms as $term => $definition)
                                        <tr>
                                            <td width="162" align="left" valign="top"><a
                                                    name="{{ $term }}">{{ ucfirst($term) }}</a></td>
                                            <td width="246" align="left" valign="top">{{ $definition }}<br>&nbsp;
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="boxes-button-section">
                            <div class="EBB-team-title">
                                ...
                                <p>Get the right terms and rate, work with our <a href="{{ route('financing') }}"
                                        class="sellorgive">mortgage specialists</a>.</p>
                            </div>
