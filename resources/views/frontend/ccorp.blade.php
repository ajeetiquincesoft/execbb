            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>A C corporation is not actually a business structure, but the "tax status" of a company. All
                            corporations are C Corporations unless they opt to take advantage of a provision in both federal
                            and state tax laws to become <a href="{{ route('scorp') }}"
                                style="color: #7F2149; text-decoration: underline;">S corporations</a>.</p>
                        <p>Taxes on profits of a C Corporation are paid both by the corporation itself and by the
                            shareholders when the profits are received as dividends. However, shareholders cannot deduct any
                            losses posted by the C Corporation.</p>
                    </div>
                </div>
                <!-- Side Panel -->
