            ...
            <div class="row px-3 px-md-5 ab_ebb">
                ...
                <div class="col-md-8 main-head">
                    <div class="Content-text question">
                        ...
                        <p>In a Corporation the liability of the owners is limited to the amount they pay for their shares
                            of stock. A Corporation is a legal entity, and its continuity is unaffected by death or the
                            transfer of shares of stock by any or all owners.</p>
                        <p>One disadvantage of most Corporations is double taxation; income tax is levied upon profits and
                            dividends after they are paid to the stockholders</p>
                        <p>However, in S Corporations the profits are passed through to the individual stockholders, much
                            the same way as in a partnership. The result is no federal income tax to the corporation as an
                            entity.</p>
                        <p>There are many differences between <a href="{{ route('ccorp') }}"
                                style="color: #7F2149; text-decoration: underline;">C Corporations</a>, <a
                                href="{{ route('scorp') }}" style="color: #7F2149; text-decoration: underline;">S
                                Corporations</a> and <a href="{{ route('llccomp') }}"
                                style="color: #7F2149; text-decoration: underline;">LLCs</a>. There is also a taxation
                            arrangement known as a <a href="{{ route('qsss') }}"
