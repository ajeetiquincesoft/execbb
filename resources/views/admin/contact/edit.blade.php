                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control" id="type" name="type">
                                ...
                                @foreach ($contact_types as $contact_type)
                                    <option value="{{ $contact_type->Type }}"
                                        {{ $contact->Type == $contact_type->Type ? 'selected' : '' }}>
                                        {{ $contact_type->Description }}</option>
                                @endforeach
                            </select>
                            @error('type')
                            ...
                            <select id="State" class="form-select" name="contact_state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ $contact->State == $value->State ? 'selected' : '' }}>{{ $value->StateName }}
                                    </option>
                                @endforeach
                            </select>
                            @error('contact_state')
