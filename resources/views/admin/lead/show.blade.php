                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="{{ url('assets/images/exp_date.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Appointment</span></td>
                                            <td class="text-end">
                                                {{ \Carbon\Carbon::parse($lead->AppointmentDate)->format('m/d/Y') }}</td>
                                        </tr>

                                        <tr>
                                            <td><img src="{{ url('assets/images/approx_sale.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Approx. Sales</span></td>
                                            <td class="text-end">${{ number_format($lead->AnnSales) }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/ask_sale.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Ask Sales</span></td>
                                            <td class="text-end">${{ number_format($lead->REAsking) }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/ask_sale.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Years In Bus</span></td>
                                            <td class="text-end">{{ $lead->YearsInBus }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/press_owner.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Press Owner</span></td>
                                            <td class="text-end">{{ $lead->PresentOwner }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/size_of_facility.png') }}"
                                                    alt=""><span class="ml-2 fw-600">Size of Facility</span></td>
                                            <td class="text-end">{{ $lead->SizeOfFacility }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/price.png') }}" alt=""><span
                                                    class="ml-2 fw-600">If Yes Asking Price</span></td>
                                            <td class="text-end">${{ number_format($lead->REAsking) }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/ad_date.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Ad Date</span></td>
                                            <td class="text-end">
                                                {{ \Carbon\Carbon::parse($lead->AdDate)->format('m/d/Y') }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/ask_sale.png') }}" alt=""><span
                                                    class="ml-2 fw-600">FSBO</span></td>
                                            <td class="text-end">{{ $lead->FSBO }}</td>
                                        </tr>
                                        <tr>
                                            <td><img src="{{ url('assets/images/ad_copy.png') }}" alt=""><span
                                                    class="ml-2 fw-600">Ad Copy</span></td>
