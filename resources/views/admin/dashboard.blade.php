    ...
    <div class="container-fluid content bg-light">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 ">
                <a href="{{ route('all.listing') }}" class="card-link">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('list.agent') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Total Agents</h3>
                            <span>{{ $agents }}</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('list.buyer') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Total Buyers</h3>
                            <span>{{ $buyers }}</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('all.showing') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Showings</h3>
                            <span>{{ $showings }}</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('all.offer') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Offers</h3>
                            <span>{{ $offers }}</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <a href="{{ route('all.lead') }}" class="card-link">
                    <div class="card view-data">
                        <div>
                            <h3>Total Leads</h3>
                            <span>{{ $leads }}</span>
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="legend-container">
                                <ul style="list-style-type: none; ">
                                    <li><span
                                            style="color:#4C1A2A;">&#9679;</span>{{ number_format($activeListingsPercentage, 2) . '%' }}
                                    </li>
                                    <li><span
                                            style="color:#D3B0B7;">&#9679;</span>{{ number_format($inactiveListingsPercentage, 2) . '%' }}
                                    </li>
                                </ul>
                            </div>
