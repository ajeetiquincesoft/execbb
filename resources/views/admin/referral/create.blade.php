...
@section('content')
                    ...
                    <div class="row mb-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="ref_type">
                                ...
                                @foreach ($referral_types as $key => $referral_type)
                                    <option value="{{ $referral_type->RefTypeID }}"
                                        {{ old('ref_type') == $referral_type->RefTypeID ? 'selected' : '' }}>
                            ...
                            <select class="form-select" aria-label="Default select example" name="ref_source">
                                ...
                                @foreach ($referral_sources as $key => $referral_source)
                                    <option value="{{ $referral_source->RefID }}"
                                        {{ old('ref_source') == $referral_source->RefID ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="referral_state" class="form-select" name="referral_state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ old('referral_state') == $value->State ? 'selected' : '' }}>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#referral_form input').on('keyup change', function() {
                $(this).valid();
            });
        });
    </script>
