                            ...
                            @forelse($referrals as $index =>$referral)
                                <tr>
                                    ...
                                    <td class="list-btn">
                                        ...
                                        <form action="{{ route('referral.destroy', $referral->RefID) }}" method="post"
                                            class="referral_delete" id="delete-referral-{{ $referral->RefID }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-sm" title="Delete"
                                                onclick="referralDelete('{{ $referral->RefID }}')">
