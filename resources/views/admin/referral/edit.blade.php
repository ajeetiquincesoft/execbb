                ...
                <div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Listing Reffered By <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="follow_up" name="follow_up"
                                value="{{ $referral->RefCompany }}">
                            @error('follow_up')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Broker of Record</label>
                            <input type="text" class="form-control" id="broke_of_rac" name="broke_of_rac"
                                value="{{ $referral->BrokOfRec }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="State" class="form-select" name="state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ $referral->State == $value->State ? 'selected' : '' }}>{{ $value->StateName }}
                                    </option>
                                @endforeach
                            </select>
                            @error('state')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="ref_fee" name="ref_fee"
                                value="{{ $referral->RefFee }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Flat Fee</label>
                            <input type="text" class="form-control" id="flat_fee" name="flat_fee"
                                value="{{ $referral->FlatFee }}">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="expDate">Ref Amt Paid</label>
                            <input type="text" class="form-control" id="ref_amt_paid" name="ref_amt_paid"
                                value="{{ $referral->RefAmt }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="ref_type">
                                ...
                                @foreach ($referral_types as $key => $referral_type)
                                    <option value="{{ $referral_type->RefTypeID }}"
                                        {{ $referral->RefType == $referral_type->RefTypeID ? 'selected' : '' }}>
                                        {{ $referral_type->RefTypeDescript }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="ref_source">
                                ...
                                @foreach ($referral_sources as $key => $referral_source)
                                    <option value="{{ $referral_source->RefID }}"
                                        {{ $referral->RefSource == $referral_source->RefID ? 'selected' : '' }}>
                                        {{ $referral_source->RefSourceDescrip }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="referral_address" name="referral_address"
                                value="{{ $referral->ReferredAdd1 }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="cityStateZip" class="form-label">City</label>
                            <input type="text" id="referral_city" class="form-control" placeholder="City"
                                name="referral_city" value="{{ $referral->ReferredCity }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="cityStateZip" class="form-label">City</label>
                            <select id="referral_state" class="form-select" name="referral_state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ $referral->ReferredState == $value->State ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="cityStateZip" class="form-label">City</label>
                            <input type="text" id="referral_zip" class="form-control" placeholder="Zip"
                                name="referral_zip" value="{{ $referral->ReferredZip }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Phone</label>
                            <input type="text" class="form-control" id="referral_phone" name="referral_phone"
                                value="{{ $referral->ReferredPhone }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Ref Interest</label>
                            <input type="text" class="form-control" id="ref_interest" name="ref_interest"
                                value="{{ $referral->ReferredInterest }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="expDate">Ref DBA</label>
                            <input type="text" class="form-control" id="ref_dba" name="ref_dba"
                                value="{{ $referral->ReferredDBA }}">
                        </div>
