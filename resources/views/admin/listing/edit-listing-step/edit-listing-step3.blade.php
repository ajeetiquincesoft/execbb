        ...
        <div class="row card p-4">
            <form id="addnewliststep3" action="{{ route('update.listing.step3', $listingData->ListingID) }}" method="post">
                            ...
                            <div class="d-flex">
                                <div class="col-sm-6 p-0  mb-3">
                                    ...
                                    <input type="text" class="form-control" id="managementAgentName"
                                        name="managementAgentName" value="{{ $listingData->MgtAgentName }}">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="managementAgentPhone"
                                        name="managementAgentPhone" value="{{ $listingData->MgtAgentPh }}">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class="form-control" id="referringAgentPhone"
                                        name="referringAgentPhone" value="{{ $listingData->RefAgentPh }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" id="listingDate" name="listingDate"
                                value="{{ \Carbon\Carbon::parse($listingData->ListDate)->format('Y-m-d') }}"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" id="expDate" name="expDate"
                                value="{{ \Carbon\Carbon::parse($listingData->ExpDate)->format('Y-m-d') }}"
                            ...
                            <select id="listingType" class="form-select" name="listingType">
                                ...
                                @foreach ($listingTypes as $key => $listingType)
                                    <option value="{{ $listingType->ListType }}"
                                        {{ $listingType->ListType == $listingData->ListType ? 'selected' : '' }}>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input" id="untilSolid" name="untilSolid"
                                value="1" {{ $listingData->UntilSold == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mb-2">
                            ...
                            <select id="agent" name="agents" class="form-select">
                                ...
                                @foreach ($agents as $key => $agent)
                                    <option value="{{ $agent->agent_info->AgentID }}"
                                        {{ $agent->agent_info->AgentID == $listingData->AgentID ? 'selected' : '' }}>
                                        {{ $agent->agent_info->FName }} {{ $agent->agent_info->LName }}</option>
                                @endforeach
                            </select>
                            @error('agents')
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="realEstate" name="realEstate"
                                value="1" {{ $listingData->RealEstate == 1 ? 'checked' : '' }}>
                        </div>
                        ...
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="optionToBuy" name="optionToBuy"
                                value="1" {{ $listingData->ToBuy == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="soldByEBB" name="soldByEBB"
                                value="1" {{ $listingData->SoldEBB == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center" style="overflow:auto;">
                    <div>
                        <a href="{{ route('edit.listing.step2', $listingData->ListingID) }}"><button class="btn-primary"
