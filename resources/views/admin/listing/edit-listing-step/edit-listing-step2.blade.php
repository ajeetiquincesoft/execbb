        ...
        <div class="row card p-4">
            <form id="addnewliststep2" action="{{ route('update.listing.step2', $listingData->ListingID) }}" method="post">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4" style="height: 70px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="basement" name="basement" value="1"
                                {{ $listingData->Basement == 1 ? 'checked' : '' }} onchange="changeBasementValue()">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="baseMonthlyRent" name="baseMonthlyRent"
                                value="{{ $listingData->BaseMonthRent }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="yearsEstablished" name="yearsEstablished"
                                value="{{ $listingData->YrsEstablished }}">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="yearsPrevOwner" name="yearsPrevOwner"
                                value="{{ $listingData->YrsPresentOwner }}">
                            ...
                            <div class="d-flex">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="interestHot" name="motivation"
                                        value="Hot" {{ $listingData->Motivation == 'Hot' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="interestMedium" name="motivation"
                                        value="Medium" {{ $listingData->Motivation == 'Medium' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="interestCold" name="motivation"
                                        value="Cold" {{ $listingData->Motivation == 'Cold' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control" id="PTEmp" name="PTEmp"
                                        value="{{ $listingData->PTEmp }}" placeholder="Part Time">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control" id="FTEmp" name="FTEmp"
                                        value="{{ $listingData->FTEmp }}" placeholder="Full Time">
                                </div>
                            </div>
                            <!-- <label>Employees</label>
                                            <div class="d-flex">
                ...
                <div class="d-flex justify-content-center" style="overflow:auto;">
                    <div>
                        <a href="{{ route('edit.listing.step1', $listingData->ListingID) }}"><button class="btn-primary"
