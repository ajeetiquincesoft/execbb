                ...
                <div class="tab" style="display: block;">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            <label for="busCategory" class="form-label">Bus. Category <span
                                    class="text-danger">*</span></label>
                            <select id="busCategory" class="form-select" name="bus_category">
                                <option value="" selected="">Select category</option>
                                @foreach ($categoryData as $key => $data)
                                    <option value="{{ $data->CategoryID }}"
                                        {{ old('bus_category') == $data->CategoryID || session('formData.bus_category') == $data->CategoryID ? 'selected' : '' }}>
                                        {{ $data->BusinessCategory }}</option>
                                @endforeach
                            </select>
                            @error('bus_category')
                            ...
                            <select id="busType" class="form-select" name="bus_type">
                                ...
                                @foreach ($sub_categories as $key => $bus_type)
                                    <option value="{{ $bus_type->SubCatID }}"
                                        {{ old('bus_type') == $bus_type->SubCatID || session('formData.bus_type') == $bus_type->SubCatID ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4" style="height: 70px;">
                            ...
                            <input type="checkbox" id="franchise" class="form-check-input" name="franchise" value="1"
                                {{ old('franchise') || session('formData.franchise') == 1 ? 'checked' : '' }}
                                onchange="changeFranchiseValue()">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            <label for="cropName" class="form-label">Corp Name <span class="text-danger">*</span></label>
                            <input type="text" id="cropName" class="form-control" name="cropName"
                                value="{{ session('formData.cropName') ?? old('cropName') }}">
                            @error('cropName')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="dba" class="form-control" name="dba"
                                value="{{ session('formData.dba') ?? old('dba') }}">
                            @error('dba')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="productMix" class="form-control" name="productMix"
                                value="{{ session('formData.productMix') ?? old('productMix') }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" id="address" class="form-control" name="address"
                                value="{{ session('formData.address') ?? old('address') }}">
                            @error('address')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="city" class="form-control" placeholder="City" name="city"
                                value="{{ session('formData.city') ?? old('city') }}">
                            @error('city')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-2">
                            ...
                            <select id="State" class="form-select" name="state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ old('state') == $value->State || session('formData.state') == $value->State ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="Zip" class="form-control" placeholder="Zip" name="zip_code"
                                value="{{ session('formData.zip_code') ?? old('zip_code') }}">
                            @error('zip_code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                            ...
                            <select id="country" class="form-select" name="country">
                                ...
                                @foreach ($counties as $key => $country)
                                    <option value="{{ $country->County }}"
                                        {{ old('country') == $country->County || session('formData.country') == $country->County ? 'selected' : '' }}>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <input type="tel" id="phone" class="form-control" name="phone"
                                value="{{ session('formData.phone') ?? old('phone') }}">
                            @error('phone')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="fax" class="form-control" name="fax"
                                value="{{ session('formData.fax') ?? old('fax') }}">
                        </div>
                        <div class="col-md-4" style="height: 70px;">
                            <label for="featuredListing" class="form-check-label">Featured Listing</label>
                            <input type="checkbox" id="featuredListing" class="form-check-input" name="featuredListing"
                                value="1"
                                {{ old('featuredListing') || session('formData.featureCheckbox') == 1 ? 'checked' : '' }}
                                ...
                                <div class="avatar-circle1">
                                    @if (session('formData.listing_img'))
                                        <img id="avatar-preview"
                                            src="{{ asset('assets/uploads/images/' . session('formData.listing_img')) }}"
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="firstName" class="form-control" name="first_name"
                                value="{{ session('formData.first_name') ?? old('first_name') }}">
                            @error('first_name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="lastName" class="form-control" name="last_name"
                                value="{{ session('formData.last_name') ?? old('last_name') }}">
                            @error('last_name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="homeAddress" class="form-control" name="home_address"
                                value="{{ session('formData.home_address') ?? old('home_address') }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="city2" class="form-control" placeholder="City"
                                name="user_city" value="{{ session('formData.user_city') ?? old('user_city') }}">
                            @error('user_city')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="State2" class="form-select" name="user_state">
                                ...
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->State }}"
                                        {{ old('user_state') == $value->State || session('formData.user_state') == $value->State ? 'selected' : '' }}>
                                        {{ $value->StateName }}</option>
                                @endforeach
                            </select>
                            @error('user_state')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="Zip2" class="form-control" placeholder="Zip"
                                name="user_zip_code"
                                value="{{ session('formData.user_zip_code') ?? old('user_zip_code') }}">
                            @error('user_zip_code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" id="email" class="form-control" name="user_email"
                                value="{{ session('formData.user_email') ?? old('user_email') }}">
                            @error('user_email')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="homePhone" class="form-control" name="user_home_phone"
                                value="{{ session('formData.user_home_phone') ?? old('user_home_phone') }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="homeFax" class="form-label">Home Fax</label>
                            <input type="text" id="homeFax" class="form-control" name="user_home_fax"
                                value="{{ session('formData.user_home_fax') ?? old('user_home_fax') }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-4 mb-3">
                            <label for="pager" class="form-label">Pager</label>
                            <input type="text" id="pager" class="form-control" name="user_pager"
                                value="{{ session('formData.user_pager') ?? old('user_pager') }}">
                        </div>
                        <div class="col-md-4" style="height: 70px;">
                            <label for="review" class="form-check-label">Review</label>
                            <input type="checkbox" id="review" class="form-check-input" name="review"
                                value="1"
                                {{ old('review') || session('formData.reviewCheckbox') == 1 ? 'checked' : '' }}
    ...
    <script>
        $(document).ready(function() {
            $('#busCategory').change(function() {
                ...
                if (id) {
                    $.ajax({
                        url: "{{ route('get.options', ['id' => '__ID__']) }}".replace('__ID__',
                            id),
                        type: 'GET',
                        dataType: 'json',
