        ...
        <div class="row card p-4">
            <form id="addnewliststep3" action="{{ route('store.listing.step3') }}" method="post">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="d-flex">
                                <div class="col-sm-6 p-0  mb-3">
                                    ...
                                    <input type="text" class="form-control" id="managementAgentName"
                                        name="managementAgentName"
                                        value="{{ session('formData.managementAgentName') ?? old('managementAgentName') }}">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="managementAgentPhone"
                                        name="managementAgentPhone"
                                        value="{{ session('formData.managementAgentPhone') ?? old('managementAgentPhone') }}">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6  mb-2">
                            ...
                            <div class="d-flex">
                                    ...
                                    <select id="referringAgentName" class="form-select" name="referringAgentName">
                                        ...
                                        @foreach ($agents as $key => $agent)
                                            <option value="{{ $agent->agent_info->AgentUserRegisterId }}"
                                                {{ old('referringAgentName') == $agent->agent_info->AgentUserRegisterId || session('formData.referringAgentName') == $agent->agent_info->AgentUserRegisterId ? 'selected' : '' }}>
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class="form-control" id="referringAgentPhone"
                                        name="referringAgentPhone"
                                        value="{{ session('formData.referringAgentPhone') ?? old('referringAgentPhone') }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" id="listingDate" name="listingDate"
                                value="{{ session('formData.listingDate') ?? old('listingDate') }}"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" id="expDate" name="expDate"
                                value="{{ session('formData.expDate') ?? old('expDate') }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="listingType" class="form-select" name="listingType">
                                ...
                                @foreach ($listingTypes as $key => $listingType)
                                    <option value="{{ $listingType->ListType }}"
                                        {{ old('listingType') == $listingType->ListType || session('formData.listingType') == $listingType->ListType ? 'selected' : '' }}>
                                        {{ $listingType->Description }}</option>
                                @endforeach
                            </select>
                            @error('listingType')
                                <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="coBroker" name="coBroker"
                                value="{{ session('formData.coBroker') ?? old('coBroker') }}">
                            @error('coBroker')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="reasonForSale" name="reasonForSale"
                                value="{{ session('formData.reasonForSale') ?? old('reasonForSale') }}">
                            @error('reasonForSale')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="interest" name="interest"
                                value="{{ session('formData.interest') ?? old('interest') }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="addTerms">Add. Terms</label>
                            <input type="text" class="form-control" id="addTerms" name="addTerms"
                                value="{{ session('formData.addTerms') ?? old('addTerms') }}">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="invInPrice">Inv. in Price</label>
                            <input type="number" class="form-control" id="invInPrice" name="invInPrice"
                                value="{{ session('formData.invInPrice') ?? old('invInPrice') }}">
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="invNotInPrice">Inv. Not in Price</label>
                            <input type="number" class="form-control" id="invNotInPrice" name="invNotInPrice"
                                value="{{ session('formData.invNotInPrice') ?? old('invNotInPrice') }}">
                        </div>
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input" id="untilSolid" name="untilSolid"
                                value="1"
                                {{ old('untilSolid') || session('formData.untilSolid') == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mb-2">
                            ...
                            <select id="agent" name="agents" class="form-select select2">
                                ...
                                @foreach ($agents as $key => $agent)
                                    <option value="{{ $agent->agent_info->AgentID }}"
                                        {{ old('agents') == $agent->agent_info->AgentID || session('formData.agents') == $agent->agent_info->AgentID ? 'selected' : '' }}>
                                        {{ $agent->agent_info->FName }} {{ $agent->agent_info->LName }}</option>
                                @endforeach
                            </select>
                            @error('agents')
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="commission" name="commission"
                                value="{{ session('formData.commission') ?? old('commission') }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="flatFee">Flat Fee</label>
                            <input type="number" class="form-control" id="flatFee" name="flatFee"
                                value="{{ session('formData.flatFee') ?? old('flatFee') }}">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="reAskingPrice">Re Asking Price</label>
                            <input type="number" class="form-control" id="reAskingPrice" name="reAskingPrice"
                                value="{{ session('formData.reAskingPrice') ?? old('reAskingPrice') }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="realEstate" name="realEstate"
                                value="1"
                                {{ old('realEstate') || session('formData.realEstate') == 1 ? 'checked' : '' }}>
                        </div>
                        ...
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="optionToBuy" name="optionToBuy"
                                value="1"
                                {{ old('optionToBuy') || session('formData.optionToBuy') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3" style="height: 80px;">
                            ...
                            <input type="checkbox" class="form-check-input" id="soldByEBB" name="soldByEBB"
                                value="1"
                                {{ old('soldByEBB') || session('formData.soldByEBB') == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center" style="overflow:auto;">
                    <div>
                        <a href="{{ route('create.listing.step2') }}"><button class="btn-primary" type="button"
