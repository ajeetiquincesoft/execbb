                        ...
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col" class="checkList"><label
                                        ...
                                        <input type="checkbox" name="checkOffer" value="" class="custom-control-input"
                                            id="checkAllOffer">
                                ...
                                <tr>
                                    <td class="checkList">
                                        <label class="custom-control custom-checkbox mb-1 align-self-center pr-4">
                                            <input type="checkbox" name="offer_id[]" value="{{ $offer->OfferID }}"
                                                class="custom-control-input offer-check">
                                            <span class="custom-control-label">&nbsp;</span>
                                        </label>
                                    </td>
                                    <td>{{ $offer->OfferID }}</td>
                                    ...
                                    <td class="list-btn">
                                        ...
                                        <form action="{{ route('offer.destroy', $offer->OfferID) }}" method="post"
                                            ...
                                            <button type="button" class="btn btn-sm" title="Delete"
                                                onclick="offerDelete('{{ $offer->OfferID }}')">
