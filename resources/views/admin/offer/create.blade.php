                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="offerID" name="offerID"
                                    value="{{ session('offerData.offerID') ?: old('offerID') ?: $nextOfferId }}" readonly>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="companyName" name="companyName">
                                    ...
                                    @foreach ($listings as $listing)
                                        <option value="{{ $listing->ListingID }}"
                                            {{ old('companyName') == $listing->ListingID || session('offerData.companyName') == $listing->ListingID ? 'selected' : '' }}>
                                            {{ trim($listing->CorpName) !== '' ? $listing->CorpName : $listing->DBA }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-4" style="height: 70px;">
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    @foreach ($offer_types as $offer_type)
                                        <option value="{{ $offer_type->Status }}"
                                            {{ old('status') == $offer_type->Status || session('offerData.status') == $offer_type->Status || $offer_type->Status == 'Pending' ? 'selected' : '' }}>
                                            {{ $offer_type->Status }}</option>
                                    @endforeach
                                </select>
                                @error('status')
                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="row mb-2">
                                ...
                                <select class="form-control" id="buyer" name="buyer">
                                    ...
                                    @foreach ($buyers as $buyer)
                                        <option value="{{ $buyer->BuyerID }}"
                                            {{ old('buyer') == $buyer->BuyerID || session('offerData.buyer') == $buyer->BuyerID ? 'selected' : '' }}>
                                            {{ $buyer->FName }}</option>
                                    @endforeach
                                </select>
                                @error('buyer')
                                ...
                                <select class="form-control" id="listingAgent" name="listingAgent">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->AgentID }}"
                                            {{ old('listingAgent') == $agent->AgentID || session('offerData.listingAgent') == $agent->AgentID ? 'selected' : '' }}>
                                            {{ $agent->FName }} {{ $agent->LName }} </option>
                                    @endforeach
                                </select>
                                @error('listingAgent')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="sellingAgent" name="sellingAgent">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->AgentID }}"
                                            {{ old('sellingAgent') == $agent->AgentID || session('offerData.sellingAgent') == $agent->AgentID ? 'selected' : '' }}>
                                            {{ $agent->FName }} {{ $agent->LName }}</option>
                                    @endforeach
                                </select>
                                @error('sellingAgent')
                        ...
                        <div class="row mb-2">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="dateOfOffer" name="dateOfOffer"
                                    value="{{ session('offerData.dateOfOffer') ?? old('dateOfOffer') }}">
                                @error('dateOfOffer')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="expDate" name="expDate"
                                    value="{{ session('offerData.expDate') ?? old('expDate') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="accDate" name="accDate"
                                    value="{{ session('offerData.accDate') ?? old('accDate') }}"
                                    min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                @error('accDate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="closeDate" name="closeDate"
                                    value="{{ session('offerData.closeDate') ?? old('closeDate') }}"
                                    min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                @error('closeDate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="purchasePrice" name="purchasePrice"
                                    value="{{ session('offerData.purchasePrice') ?? old('purchasePrice') }}">
                                @error('purchasePrice')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-4" style="height: 70px;">
                                ...
                                <input type="number" class="form-control" id="downPayment" name="downPayment"
                                    value="{{ session('offerData.downPayment') ?? old('downPayment') }}">
                                @error('downPayment')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-4" style="height: 70px;">
                                ...
                                <input type="number" class="form-control" id="commAmount" name="commAmount"
                                    value="{{ session('offerData.commAmount') ?? old('commAmount') }}">
                                @error('commAmount')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="commissionPercent"
                                    ...
                                    value="{{ session('offerData.commissionPercent') ?? old('commissionPercent') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="balanceDue" name="balanceDue"
                                    value="{{ session('offerData.balanceDue') ?? old('balanceDue') }}">
                                @error('balanceDue')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-4 offer-data mb-3">
                                ...
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="offer-downPayBal2" name="downPayBal2"
                                        value="{{ session('offerData.downPayBal2') ?? old('downPayBal2') }}">
                                </div>
                                <div class="field-item mb-3">
                            ...
                            <div class="col-md-4 counter mb-3">
                                ...
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="counter-price" name="co_price"
                                        value="{{ session('offerData.co_price') ?? old('co_price') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-deposit">Deposit</label>
                                    <input type="number" class="form-control" id="counter-deposit" name="co_deposit"
                                        value="{{ session('offerData.co_deposit') ?? old('co_deposit') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-addDeposit">Add. Deposit</label>
                                    <input type="number" class="form-control" id="counter-addDeposit"
                                        name="co_addDeposit"
                                        value="{{ session('offerData.co_addDeposit') ?? old('co_addDeposit') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-downPayBal">Down Pay Bal.</label>
                                    <input type="number" class="form-control" id="counter-downPayBal"
                                        name="co_downPayBal"
                                        value="{{ session('offerData.co_downPayBal') ?? old('co_downPayBal') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-downPayBal2">Down Pay Bal.2</label>
                                    <input type="number" class="form-control" id="counter-downPayBal2"
                                        name="co_downPayBal2"
                                        value="{{ session('offerData.co_downPayBal2') ?? old('co_downPayBal2') }}">
                                </div>
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="counter-totalDownPayBal"
                                        ...
                                        value="{{ session('offerData.co_totalDownPayBal') ?? old('co_totalDownPayBal') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-assumption">Assumption</label>
                                    <input type="number" class="form-control" id="counter-assumption"
                                        name="co_assumption"
                                        value="{{ session('offerData.co_assumption') ?? old('co_assumption') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-addAssumption">Add Assumption</label>
                                    <input type="number" class="form-control" id="counter-addAssumption"
                                        name="co_addAssumption"
                                        value="{{ session('offerData.co_addAssumption') ?? old('co_addAssumption') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-balanceDue">Balance Due</label>
                                    <input type="number" class="form-control" id="counter-balanceDue"
                                        name="co_balanceDue"
                                        value="{{ session('offerData.co_balanceDue') ?? old('co_balanceDue') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-perMonth">Per Month</label>
                                    <input type="number" class="form-control" id="counter-perMonth" name="co_perMonth"
                                        value="{{ session('offerData.co_perMonth') ?? old('co_perMonth') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-interest">Interest</label>
                                    <input type="number" class="form-control" id="counter-interest" name="co_interest"
                                        value="{{ session('offerData.co_interest') ?? old('co_interest') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-addTerms">Add. Terms</label>
                                    <input type="text" class="form-control" id="counter-addTerms" name="co_addTerms"
                                        value="{{ session('offerData.co_addTerms') ?? old('co_addTerms') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-inventory">Inventory</label>
                                    <input type="number" class="form-control" id="counter-inventory"
                                        name="co_inventory"
                                        value="{{ session('offerData.co_inventory') ?? old('co_inventory') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="counter-maxInventory">Max. Inventory</label>
                                    <input type="number" class="form-control" id="counter-maxInventory"
                                        name="co_maxInventory"
                                        value="{{ session('offerData.co_maxInventory') ?? old('co_maxInventory') }}">
                                </div>
                            ...
                            <div class="col-md-4 accepted mb-3">
                                ...
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="accepted-price" name="ac_price"
                                        value="{{ session('offerData.ac_price') ?? old('ac_price') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-deposit">Deposit</label>
                                    <input type="number" class="form-control" id="accepted-deposit" name="ac_deposit"
                                        value="{{ session('offerData.ac_deposit') ?? old('ac_deposit') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-addDeposit">Add. Deposit</label>
                                    <input type="number" class="form-control" id="accepted-addDeposit"
                                        name="ac_addDeposit"
                                        value="{{ session('offerData.ac_addDeposit') ?? old('ac_addDeposit') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-downPayBal">Down Pay Bal.</label>
                                    <input type="number" class="form-control" id="accepted-downPayBal"
                                        name="ac_downPayBal"
                                        value="{{ session('offerData.ac_downPayBal') ?? old('ac_downPayBal') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-downPayBal2">Down Pay Bal.2</label>
                                    <input type="number" class="form-control" id="accepted-downPayBal2"
                                        name="ac_downPayBal2"
                                        value="{{ session('offerData.ac_downPayBal2') ?? old('ac_downPayBal2') }}">
                                </div>
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="accepted-totalDownPayBal"
                                        ...
                                        value="{{ session('offerData.ac_totalDownPayBal') ?? old('ac_totalDownPayBal') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-assumption">Assumption</label>
                                    <input type="number" class="form-control" id="accepted-assumption"
                                        name="ac_assumption"
                                        value="{{ session('offerData.ac_assumption') ?? old('ac_assumption') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-addAssumption">Add Assumption</label>
                                    <input type="number" class="form-control" id="accepted-addAssumption"
                                        name="ac_addAssumption"
                                        value="{{ session('offerData.ac_addAssumption') ?? old('ac_addAssumption') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-balanceDue">Balance Due</label>
                                    <input type="number" class="form-control" id="accepted-balanceDue"
                                        name="ac_balanceDue"
                                        value="{{ session('offerData.ac_balanceDue') ?? old('ac_balanceDue') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-perMonth">Per Month</label>
                                    <input type="number" class="form-control" id="accepted-perMonth" name="ac_perMonth"
                                        value="{{ session('offerData.ac_perMonth') ?? old('ac_perMonth') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-interest">Interest</label>
                                    <input type="number" class="form-control" id="accepted-interest" name="ac_interest"
                                        value="{{ session('offerData.ac_interest') ?? old('ac_interest') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-addTerms">Add. Terms</label>
                                    <input type="text" class="form-control" id="accepted-addTerms" name="ac_addTerms"
                                        value="{{ session('offerData.ac_addTerms') ?? old('ac_addTerms') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-inventory">Inventory</label>
                                    <input type="number" class="form-control" id="accepted-inventory"
                                        name="ac_inventory"
                                        value="{{ session('offerData.ac_inventory') ?? old('ac_inventory') }}">
                                </div>
                                <div class="field-item mb-3">
                                    <label for="accepted-maxInventory">Max. Inventory</label>
                                    <input type="number" class="form-control" id="accepted-maxInventory"
                                        name="ac_maxInventory"
                                        value="{{ session('offerData.ac_maxInventory') ?? old('ac_maxInventory') }}">
                                </div>
                    ...
                    <div class="form-multi-tab">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="checkbox" id="realEstateTransaction" name="realEstateTransaction"
                                    value="1"
                                    {{ old('realEstateTransaction') || session('offerData.realEstateTransaction') == 1 ? 'checked' : '' }}
                                    onchange="changeRealStateTransValue()">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="depositCheck">Deposit Check</label>
                                <input type="text" class="form-control" id="depositCheck" name="depositCheck"
                                    value="{{ session('offerData.depositCheck') ?? old('depositCheck') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="bank">Bank</label>
                                <input type="text" class="form-control" id="bank" name="bank_name"
                                    value="{{ session('offerData.bank_name') ?? old('bank_name') }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="dateDeposited" name="dateDeposited"
                                    value="{{ session('offerData.dateDeposited') ?? old('dateDeposited') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="nameOnCheck">Name on Check</label>
                                <input type="text" class="form-control" id="nameOnCheck" name="nameOnCheck"
                                    value="{{ session('offerData.nameOnCheck') ?? old('nameOnCheck') }}">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Check on Hold</label>
                                <input type="checkbox" id="checkOnHold" name="checkOnHold" value="1"
                                    {{ old('checkOnHold') || session('offerData.checkOnHold') == 1 ? 'checked' : '' }}
                                    onchange="changeCheckOnHoldValue()">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Bounced</label>
                                <input type="checkbox" id="bounced" name="bounced" value="1"
                                    {{ old('bounced') || session('offerData.bounced') == 1 ? 'checked' : '' }}
                                    onchange="changeCheckBouncedValue()">
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="reason" name="reason"
                                    value="{{ session('offerData.reason') ?? old('reason') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="amount">Amount</label>
                                <input type="number" class="form-control" id="amount" name="amount"
                                    value="{{ session('offerData.amount') ?? old('amount') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="dateReturned">Date Returned</label>
                                <input type="date" class="form-control" id="dateReturned" name="dateReturned"
                                    value="{{ session('offerData.dateReturned') ?? old('dateReturned') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="returnCheck" name="returnCheck"
                                    value="{{ session('offerData.returnCheck') ?? old('returnCheck') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="checkReturnedTo" name="checkReturnedTo"
                                    value="{{ session('offerData.checkReturnedTo') ?? old('checkReturnedTo') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="relationship">Relationship</label>
                                <input type="text" class="form-control" id="relationship" name="relationship"
                                    value="{{ session('offerData.relationship') ?? old('relationship') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    value="{{ session('offerData.address') ?? old('address') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="">City</label>
                                <input type="text" id="city" class="form-control" placeholder="City"
                                    name="escrow_city"
                                    value="{{ session('offerData.escrow_city') ?? old('escrow_city') }}">
                                @error('escrow_city')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2">
                                ...
                                <select id="State" class="form-select" name="escrow_state">
                                    ...
                                    @foreach ($states as $key => $value)
                                        <option value="{{ $value->State }}"
                                            {{ old('escrow_state') == $value->State || session('offerData.escrow_state') == $value->State ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="Zip" class="form-control" placeholder="Zip"
                                    name="escrow_zip_code"
                                    value="{{ session('offerData.escrow_zip_code') ?? old('escrow_zip_code') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone"
                                    value="{{ session('offerData.phone') ?? old('phone') }}">
                            </div>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="buyerAccountant" name="buyerAccountant"
                                    value="{{ session('offerData.buyerAccountant') ?? old('buyerAccountant') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="sellerAccountant" name="sellerAccountant"
                                    value="{{ session('offerData.sellerAccountant') ?? old('sellerAccountant') }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="referralFeePaid" name="referralFeePaid"
                                    value="{{ session('offerData.referralFeePaid') ?? old('referralFeePaid') }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="schedClosedDate" name="schedClosedDate"
                                    value="{{ session('offerData.schedClosedDate') ?? old('schedClosedDate') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="schedCloseTime" name="schedCloseTime"
                                    value="{{ session('offerData.schedCloseTime') ?? old('schedCloseTime') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="attorneyLetters" name="attorneyLetters"
                                    value="{{ session('offerData.attorneyLetters') ?? old('attorneyLetters') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="closingAnticipationLetters"
                                    ...
                                    value="{{ session('offerData.closingAnticipationLetters') ?? old('closingAnticipationLetters') }}">
                            </div>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="form-multi-tab">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                ...
                                <input type="checkbox" id="realEstateIncluded" name="realEstateIncluded" value="1"
                                    {{ old('realEstateIncluded') || session('offerData.realEstateIncluded') == 1 ? 'checked' : '' }}
                                    onchange="changeRealEstateIncludedValue()">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label>Option to Buy</label>
                                <input type="checkbox" id="optionToBuy" name="optionToBuy" value="1"
                                    {{ old('optionToBuy') || session('offerData.optionToBuy') == 1 ? 'checked' : '' }}
                                    onchange="changeOptionToBuyValue()">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="real-price" name="rest_price"
                                    value="{{ session('offerData.rest_price') ?? old('rest_price') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="real-terms">Terms</label>
                                <input type="text" class="form-control" id="real-terms" name="rest_terms"
                                    value="{{ session('offerData.rest_terms') ?? old('rest_terms') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="real-downPay">Down Payment</label>
                                <input type="text" class="form-control" id="real-downPay" name="rest_downPay"
                                    value="{{ session('offerData.rest_downPay') ?? old('rest_downPay') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="real-balance">Balance</label>
                                <input type="text" class="form-control" id="real-balance" name="rest_balance"
                                    value="{{ session('offerData.rest_balance') ?? old('rest_balance') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="option-price" name="otb_price"
                                    value="{{ session('offerData.otb_price') ?? old('otb_price') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="option-terms">Terms</label>
                                <input type="text" class="form-control" id="option-terms" name="otb_terms"
                                    value="{{ session('offerData.otb_terms') ?? old('otb_terms') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="option-downPay">Down Payment</label>
                                <input type="text" class="form-control" id="option-downPay" name="otb_downPay"
                                    value="{{ session('offerData.otb_downPay') ?? old('otb_downPay') }}">
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                <label for="option-balance">Balance</label>
                                <input type="text" class="form-control" id="option-balance" name="otb_balance"
                                    value="{{ session('offerData.otb_balance') ?? old('otb_balance') }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="comment-area w-100 mt-4">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="contingencies" name="contingencies" rows="3"></textarea>
                                </div>
                                <div class="col-md-12 mb-3">
        ...
        $(document).ready(function() {
            ...
            form.validate({
                rules: {
                    ...
                    // Required only for Accepted or Closed
                    accDate: {
                        required: function() {
                ...
                messages: {
                    accDate: {
                        required: "Acceptance Date is required when the offer is Accepted."
                    },
                    closeDate: {
                        required: "Close Date is required when the offer is Closed."
                    }
                },
            ...
            $('#offer-downPayBal, #offer-downPayBal2').on('input', function() {
                var input1Value = parseFloat($('#offer-downPayBal').val()) ||
                    0; // Get value from input1, default to 0 if empty
                var input2Value = parseFloat($('#offer-downPayBal2').val()) ||
                    0; // Get value from input2, default to 0 if empty
            ...
            $('#counter-downPayBal, #counter-downPayBal2').on('input', function() {
                var input1Value = parseFloat($('#counter-downPayBal').val()) ||
                    0; // Get value from input1, default to 0 if empty
                var input2Value = parseFloat($('#counter-downPayBal2').val()) ||
                    0; // Get value from input2, default to 0 if empty
            ...
            $('#accepted-downPayBal, #accepted-downPayBal2').on('input', function() {
                var input1Value = parseFloat($('#accepted-downPayBal').val()) ||
                    0; // Get value from input1, default to 0 if empty
                var input2Value = parseFloat($('#accepted-downPayBal2').val()) ||
                    0; // Get value from input2, default to 0 if empty
