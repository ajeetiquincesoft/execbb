                                ...
                                <select class="form-control" id="companyName" name="companyName">
                                    ...
                                    @foreach ($listings as $listing)
                                        <option value="{{ $listing->ListingID }}"
                                            {{ $listing->ListingID == $offer->ListingID ? 'selected' : '' }}>
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    @foreach ($offer_types as $offer_type)
                                        <option value="{{ $offer_type->Status }}"
                                            {{ $offer->Status == $offer_type->Status ? 'selected' : '' }}>
                        ...
                        <div class="row mb-2">
                                ...
                                <select class="form-control" id="listingAgent" name="listingAgent">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->AgentID }}"
                                            {{ $agent->AgentID == $offer->ListingAgent ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="sellingAgent" name="sellingAgent">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->AgentID }}"
                                            {{ $agent->AgentID == $offer->SellingAgent ? 'selected' : '' }}>
                                            {{ $agent->FName }} {{ $agent->LName }}</option>
                                    @endforeach
                                </select>
                                @error('sellingAgent')
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="expDate" name="expDate"
                                    value="{{ $offer->ExpDate }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                @error('expDate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="accDate" name="accDate"
                                    value="{{ $offer->AccDate }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                @error('accDate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="closeDate" name="closeDate"
                                    value="{{ $offer->ClosingDate }}" min="{{ \Carbon\Carbon::now()->toDateString() }}">
                                @error('closeDate')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 counter mb-3">
                                ...
                                <div class="field-item mb-3">
                                    ...
                                    <input type="number" class="form-control" id="counter-assumption"
                                        name="co_assumption" value="{{ $offer->COffAssump }}">
                                </div>
                                <div class="field-item mb-3">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="checkbox" id="realEstateTransaction" name="realEstateTransaction"
                                    value="1" {{ $offer->RealEstateTrans == 1 ? 'checked' : '' }}
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="returnCheck" name="returnCheck"
                                    value="{{ $offer->CheckEBBReturnNumber }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="checkReturnedTo" name="checkReturnedTo"
                                    value="{{ $offer->CheckReturnedTo }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="relationship">Relationship</label>
                                <input type="text" class="form-control" id="relationship" name="relationship"
                                    value="{{ $offer->ReturneeRelationship }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    value="{{ $offer->ReturneeAddress }}">
                            </div>
                            <div class="col-md-4 p-0 m-0">
                                <label for="">City</label>
                                <input type="text" id="city" class="form-control" placeholder="City"
                                    name="escrow_city" value="{{ $offer->ReturneeCity }}">
                                @error('escrow_city')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2">
                                ...
                                <select id="State" class="form-select" name="escrow_state">
                                    ...
                                    @foreach ($states as $key => $value)
                                        <option value="{{ $value->State }}"
                                            {{ $value->State == $offer->ReturneeState ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="Zip" class="form-control" placeholder="Zip"
                                    name="escrow_zip_code" value="{{ $offer->ReturneeZip }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-3">
                                ...
                                <input type="checkbox" id="optionToBuy" name="optionToBuy" value="1"
                                    {{ $offer->OpToBuy == 1 ? 'checked' : '' }} onchange="changeOptionToBuyValue()">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="comment-area w-100 mt-4">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="contingencies" name="contingencies" rows="3">{{ $offer->Contingencies }}</textarea>
                                </div>
                                <div class="col-md-12 mb-3">
