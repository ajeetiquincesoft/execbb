...
@section('content')
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="honorific" name="honorific">
                                    ...
                                    <option value="mr" {{ $buyerData->Honorific == 'mr' ? 'selected' : '' }}>Mr.
                                    </option>
                                    <option value="mrs" {{ $buyerData->Honorific == 'mrs' ? 'selected' : '' }}>Mrs.
                                    </option>
                                    <option value="miss" {{ $buyerData->Honorific == 'miss' ? 'selected' : '' }}>Miss
                                    </option>
                                    <option value="ms" {{ $buyerData->Honorific == 'ms' ? 'selected' : '' }}>Ms.
                                    </option>
                                    <option value="dr" {{ $buyerData->Honorific == 'dr' ? 'selected' : '' }}>Dr.
                                    </option>
                                    <option value="prof" {{ $buyerData->Honorific == 'prof' ? 'selected' : '' }}>Prof.
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="agentID" name="agentID">
                                    ...
                                    @foreach ($agents as $key => $agent)
                                        <option value="{{ $agent->agent_info->AgentID }}"
                                            {{ $agent->agent_info->AgentID == $buyerData->AgentID ? 'selected' : '' }}>
                        ...
                        <div class="row mb-2">
                                ...
                                <select id="State" class="form-select" name="state">
                                    ...
                                    @foreach ($states as $key => $value)
                                        <option value="{{ $value->State }}"
                                            {{ strtolower($value->State) == strtolower($buyerData->State) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="zip" id="Zip" class="form-control"
                                    placeholder="Zip" value="{{ $buyerData->Zip }}">
                                @error('zip')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                                ...
                                <select id="country" class="form-select" name="country">
                                    ...
                                    @foreach ($counties as $key => $country)
                                        <option value="{{ $country->County }}"
                                            {{ $country->County == $buyerData->County ? 'selected' : '' }}>
                        ...
                        <div class="row mb-2">
                                ...
                                <select class="form-select" id="busType1" name="busType1">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ $bus_type->SubCatID == $buyerData->BusType1 ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType2" name="busType2">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ $bus_type->SubCatID == $buyerData->BusType2 ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType3" name="busType3">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ $bus_type->SubCatID == $buyerData->BusType3 ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType4" name="busType4">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ $bus_type->SubCatID == $buyerData->BusType4 ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty1" name="desiredCounty1">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ $country->County == $buyerData->BusCounty1 ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty2" name="desiredCounty2">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ $country->County == $buyerData->BusCounty2 ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty3" name="desiredCounty3">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ $country->County == $buyerData->BusCounty3 ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty4" name="desiredCounty4">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ $country->County == $buyerData->BusCounty4 ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editBuyerForm input').on('keyup change', function() {
                $(this).valid();
            });
