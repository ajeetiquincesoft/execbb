                    ...
                    <div class="form-multi-tab">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="honorific" name="honorific">
                                    ...
                                    <option value="mr"
                                        {{ old('honorific') == 'mr' || session('buyerData.honorific') == 'mr' ? 'selected' : '' }}>
                                        Mr.</option>
                                    <option value="mrs"
                                        {{ old('honorific') == 'mrs' || session('buyerData.honorific') == 'mrs' ? 'selected' : '' }}>
                                        Mrs.</option>
                                    <option value="miss"
                                        {{ old('honorific') == 'miss' || session('buyerData.honorific') == 'miss' ? 'selected' : '' }}>
                                        Miss</option>
                                    <option value="ms"
                                        {{ old('honorific') == 'ms' || session('buyerData.honorific') == 'ms' ? 'selected' : '' }}>
                                        Ms.</option>
                                    <option value="dr"
                                        {{ old('honorific') == 'dr' || session('buyerData.honorific') == 'dr' ? 'selected' : '' }}>
                                        Dr.</option>
                                    <option value="prof"
                                        {{ old('honorific') == 'prof' || session('buyerData.honorific') == 'prof' ? 'selected' : '' }}>
                                        Prof.</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="firstName" name="firstName"
                                    value="{{ session('buyerData.firstName') ?? old('firstName') }}">
                                @error('firstName')
                            ...
                            <div class="col-md-4 d-flex flex-column check-column">
                                ...
                                <input type="text" class="form-control" id="lastName" name="lastName"
                                    value="{{ session('buyerData.lastName') ?? old('lastName') }}">
                                @error('lastName')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="corporateName" name="corporateName"
                                    value="{{ session('buyerData.corporateName') ?? old('corporateName') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="agentID" name="agentID">
                                    ...
                                    @foreach ($agents as $key => $agent)
                                        <option value="{{ $agent->agent_info->AgentID }}"
                                            {{ old('agentID') == $agent->agent_info->AgentID || session('buyerData.agentID') == $agent->agent_info->AgentID ? 'selected' : '' }}>
                                            {{ $agent->agent_info->FName }} {{ $agent->agent_info->LName }}</option>
                                    @endforeach
                                </select>
                                @error('agentID')
                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label" for="cityStateZip" class="form-label">City <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label" for="cityStateZip" class="form-label">Zip <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="zip" id="Zip" class="form-control"
                                    placeholder="Zip" value="{{ session('buyerData.zip') ?? old('zip') }}">
                                @error('zip')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="dlNumber" name="dlNumber"
                                    value="{{ session('buyerData.dlNumber') ?? old('dlNumber') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3 mb-3">
                                <label class="form-label" for="homePhone">Home Phone <span
                                        class="text-danger">*</span></label>
                                <input type="tel" class="form-control" id="homePhone" name="homePhone"
                                    value="{{ session('buyerData.homePhone') ?? old('homePhone') }}">
                                @error('homePhone')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="fax" name="fax"
                                    value="{{ session('buyerData.fax') ?? old('fax') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="callWhen" name="callWhen"
                                    value="{{ session('buyerData.callWhen') ?? old('callWhen') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3 d-flex flex-column check-column">
                                <label class="form-label" for="corporateBuyer" class="form-check-label">Corporate
                                    Buyer</label>
                                <input type="checkbox" class="form-check-input" id="corporateBuyer"
                                    name="corporateBuyer" value="1"
                                    {{ old('corporateBuyer') || session('buyerData.corporateBuyer') == 1 ? 'checked' : '' }}>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label" for="preferredTerms">Proffered Terms </label>
                                <input type="number" class="form-control" id="preferredTerms" name="preferredTerms"
                                    value="{{ session('buyerData.preferredTerms') ?? old('preferredTerms') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="monthExpDate" name="monthExpDate"
                                    value="{{ session('buyerData.monthExpDate') ?? old('monthExpDate') }}">
                            </div>
                            <div class="col-md-3 d-flex flex-column check-column">
                                ...
                                <select id="country" class="form-select" name="country">
                                    ...
                                    @foreach ($counties as $key => $country)
                                        <option value="{{ $country->County }}"
                                            {{ old('country') == $country->County || session('buyerData.country') == $country->County ? 'selected' : '' }}>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="partnerName" name="partnerName"
                                    value="{{ session('buyerData.partnerName') ?? old('partnerName') }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="tel" class="form-control" id="partnerPhone" name="partnerPhone"
                                    value="{{ session('buyerData.partnerPhone') ?? old('partnerPhone') }}">
                            </div>
                            <div class="col-md-4 d-flex flex-column check-column">
                                ...
                                <input type="text" class="form-control" id="currentEmployment1"
                                    ...
                                    value="{{ session('buyerData.currentEmployment1') ?? old('currentEmployment1') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-4 mb-3">
                        ...
                        <div class="row mb-2">
                                ...
                                <select class="form-select" id="busType1" name="busType1">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ old('busType1') == $bus_type->SubCatID || session('buyerData.busType1') == $bus_type->SubCatID ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType2" name="busType2">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ old('busType2') == $bus_type->SubCatID || session('buyerData.busType2') == $bus_type->SubCatID ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType3" name="busType3">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ old('busType3') == $bus_type->SubCatID || session('buyerData.busType3') == $bus_type->SubCatID ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="busType4" name="busType4">
                                    ...
                                    @foreach ($sub_categories as $key => $bus_type)
                                        <option value="{{ $bus_type->SubCatID }}"
                                            {{ old('busType4') == $bus_type->SubCatID || session('buyerData.busType4') == $bus_type->SubCatID ? 'selected' : '' }}>
                                            {{ $bus_type->SubCategory }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty1" name="desiredCounty1">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ old('desiredCounty1') == $country->County || session('buyerData.desiredCounty1') == $country->County ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty2" name="desiredCounty2">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ old('desiredCounty2') == $country->County || session('buyerData.desiredCounty2') == $country->County ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty3" name="desiredCounty3">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ old('desiredCounty3') == $country->County || session('buyerData.desiredCounty3') == $country->County ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-6  mb-3">
                                        ...
                                        <select class="form-select" id="desiredCounty4" name="desiredCounty4">
                                            ...
                                            @foreach ($counties as $key => $country)
                                                <option value="{{ $country->County }}"
                                                    {{ old('desiredCounty4') == $country->County || session('buyerData.desiredCounty4') == $country->County ? 'selected' : '' }}>
                                                    {{ $country->County }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control" id="desiredLocation" name="desiredLocation"
                                    value="{{ session('buyerData.currentEmployment2') ?? old('currentEmployment2') }}">
                            </div>
                            <div class="col-md-4 mb-2">
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="maxPrice" name="maxPrice"
                                    value="{{ session('buyerData.maxPrice') ?? old('maxPrice') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="downPayMax" name="downPayMax"
                                    value="{{ session('buyerData.downPayMax') ?? old('downPayMax') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="annualSalesMin" name="annualSalesMin"
                                    value="{{ session('buyerData.annualSalesMin') ?? old('annualSalesMin') }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="netProfitMin" name="netProfitMin"
                                    value="{{ session('buyerData.netProfitMin') ?? old('netProfitMin') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="d-flex flex-wrap gap match-criteria">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="busInterest" name="busInterest"
                                        value="{{ session('buyerData.busInterest') ?? old('busInterest') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="location">Location</label>
                                    <input type="text" class="form-control" id="location" name="location"
                                        value="{{ session('buyerData.location') ?? old('location') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="price">Price</label>
                                    <input type="text" class="form-control" id="price" name="price"
                                        value="{{ session('buyerData.price') ?? old('price') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="downPay">Down Pay</label>
                                    <input type="text" class="form-control" id="downPay" name="downPay"
                                        value="{{ session('buyerData.downPay') ?? old('downPay') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="salesVol">Sales Vol</label>
                                    <input type="text" class="form-control" id="salesVol" name="salesVol"
                                        value="{{ session('buyerData.salesVol') ?? old('salesVol') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="profit">Profit</label>
                                    <input type="text" class="form-control" id="profit" name="profit"
                                        value="{{ session('buyerData.profit') ?? old('profit') }}">
                                </div>
                                <div class="col">
                                    <label class="form-label" for="total">Total</label>
                                    <input type="text" class="form-control" id="total" name="total"
                                        value="{{ session('buyerData.total') ?? old('total') }}">
                                </div>
                            </div>
                        </div>
                    </div>
