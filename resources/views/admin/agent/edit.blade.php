...
<div class="container-fluid content" style="background-color: #f8f9fa; padding: 2rem 2rem 0rem 2rem;">
    ...
    @if ($previous)
            <a href="{{ route('edit.agent', $previous->id) }}"><button><i class="fa fa-chevron-left"></i>Back</button></a>
        @endif

        @if ($next)
            <a href="{{ route('edit.agent', $next->id) }}"><button>Next <i class="fa fa-chevron-right"></i></button></a>
        @endif
    </div>
</div>
                        ...
                        <form id="edit-agent-form" action="{{ route('update.agent',$agent->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                     <div class="form-group mb-3">
                                        ...
                                        <input type="text" placeholder="" id="first_name" class="form-control"
                                            name="first_name" value="{{$agent->agent_info->FName }}">
                                ...
                                <div class="col-md-4">
                                     <div class="form-group mb-3">
                                        ...
                                        <input type="text" placeholder="" id="last_name" class="form-control"
                                            name="last_name" value="{{$agent->agent_info->LName }}" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" placeholder="" id="address" class="form-control"
                                            name="address" value="{{$agent->agent_info->Address1 }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" id="fax" class="form-control"
                                            name="fax"  value="{{$agent->agent_info->Fax }}">
                                        @if ($errors->has('fax'))
                            ...
                            <div class="row">
                                <div class="col-md-3" style="height: 70px;">
                                    ...
                                    <input class="form-check-input" type="checkbox" value="{{$agent->agent_info->Spouse}}" id="agentSpouse" name="spouse" onclick="changeSpouseValue()" {{ old('spouse', $agent->agent_info->Spouse) == 1 ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="" id="pager" class="form-control"
                                                name="pager" value="{{$agent->agent_info->Pager }}">
                                            @if ($errors->has('pager'))
                             ...
                             <div class="row">
                                <div class="col-md-3" style="height: 70px;">
                                        ...
                                        <input class="form-check-input" type="checkbox" value="{{$agent->agent_info->Display}}" id="display_on_web" name="display_on_web" onclick="changeDisplayValue()" {{ old('display_on_web', $agent->agent_info->Display) == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-md-3">
                                    <div class="col">
