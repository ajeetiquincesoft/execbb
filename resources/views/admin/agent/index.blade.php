                            ...
                            @forelse($agents as $index =>$agent)
                                <tr>
                                    ...
                                    <td class="list-btn">
                                        ...
                                        <form action="{{ route('agents.destroy', $agent->AgentUserRegisterId) }}"
                                            method="post" class="agent_delete"
                                            id="delete-agent-{{ $agent->AgentUserRegisterId }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-sm" title="Delete"
                                                onclick="confirmDelete('{{ $agent->AgentUserRegisterId }}')">
                                        ...
                                        @endphp
                                        <button type="button" class="btn btn-sm btn-deactivate" title="Deactivate"
                                            data-toggle="modal" data-target="#deactivateModal"
                                            data-agent-id="{{ $id }}" data-agent-name="{{ $name }}">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mt-2" name="new_agent_id" id="newAgentDropdown"
                                            required>
                ...
                if (keyword.length >= 2) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            data.forEach(agent => {
                                options +=
                                    `<option value="${agent.AgentUserRegisterId}">${agent.FName} ${agent.LName} (${agent.AgentID})</option>`;
                            });
